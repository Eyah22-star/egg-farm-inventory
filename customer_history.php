...
<div class="main-content">
    ...
    <div class="relative">
        ...
        >
            ...
            <span
                id="bell_badge"
                class="absolute top-1 right-1 w-2.5 h-2.5 bg-blue-500 rounded-full border-2 border-white <?php echo $unread_count > 0 ? '' : 'hidden'; ?>"
            ></span>
        </button>
        ...
        <div
            ...
            class="hidden absolute right-0 top-full mt-3 w-80 bg-white border border-gray-200 rounded-xl shadow-xl z-[100] overflow-hidden"
        >
